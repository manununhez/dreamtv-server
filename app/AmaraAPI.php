...
class AmaraAPI {
    ...
    */
    ...
    function __construct() {
        $host = 'https://amara.org/api/';
        $user = 'manuel_nunez';
        $APIKey = 'a0811dd51747dbc8c8404e51c6e583f3fcb0eb40';
        $APIVersion = null;
        $logger = null;
    ...
    protected function useResource($method, array $r, $q = null, $data = null, callable $filter = null) {
        ...
        if (isset($data) && $r['content_type'] === 'json') { 
    ...
    //   protected function useAllResources($method, array $r, $q = null, $data = null, callable $filter = null) {
    //     $result = array();
    //     $limit = (isset($q['limit']) ? $q['limit'] : $this->limit);
    //     $header = $this->getHeader(isset($r['content_type']) ? $r['content_type'] : null);
    ...
    // protected function getAllResources(array $r, $q = null, $data = null, callable $filter = null) {
    //     return $this->useAllResources('GET', $r, $q, $data, $filter);
    // }
    ...
    function getLastVersion($lang_info) {
        ...
        if (isset($lang_info->versions[0]->version_no)) {
            ...
            $lang_decoded = $lang_info->getData();
            return $lang_decoded;
        }
        // return $lang_decoded;
    ...
    function getTasks(array $r) {
        ...
        $query = array(
            ...
            'completed_after' => isset($r['completed_after']) ? $r['completed_after'] : null,
    ...
    //     $this->useAllResources('GET', $r, $q, $data, $filter)

    //     return $this->getAllResources($res, $query);
    // }
    ...
    function getSubtitle(array $r, &$lang_info = null) {
        ...
        $query = array(
            'format' => isset($r['format']) ? $r['format'] : 'json',
