...
class UserVideosListAdminController extends Controller
{
    ...
    {
        $grid = new Grid(new UserVideosList);
    ...
    {
        $show = new Show(UserVideosList::findOrFail($id));
    ...
    {
        $form = new Form(new UserVideosList);
